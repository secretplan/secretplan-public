...
{
    /// <summary>
    ///     Borrows from UnityEngine.UI.Navigation
    /// </summary>
    [Serializable]
    public struct Navigation : IEquatable<Navigation>
    {
        ...
        /// </summary>
        /// <remarks>
        ///     This looks like it's not flags, but it is flags, the reason is that Automatic is considered horizontal and vertical
        ///     mode combined
        /// </remarks>
        /// <example>
        ///     <code>
        ...
        /// </summary>
        /// <example>
        ///     Note: If you have a grid of elements and you are on the last element in a row it will not wrap over to the next row
        ///     it will pick the furthest element in the opposite direction.
        /// </example>
        ...
        /// </code>
        /// </example>
        public Navigable selectOnRight
        {
            get => m_SelectOnRight;
